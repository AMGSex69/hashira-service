...
export default function ScriptGenerator() {
  ...
  const copyToClipboard = () => {
    try {
      ...
      toast({
        title: "Скопировано",
        description: "Скрипт скопирован в буфер обмена",
      })
    } catch (error) {
  ...
  const exportToWord = () => {
    // Convert markdown bold to Word-compatible HTML
    ...
    const blob = new Blob(
      ...
      <head><meta charset='utf-8'><title>Скрипт</title></head>
      <body>
        ${htmlContent}
      </body>
      </html>
    ...
    toast({
      ...
      description: "Скрипт успешно экспортирован в Word",
    })
  }
